...
Classes will be held **_virtually_** on **Wednesdays** from **_9:00am to 10:30am_** (previously _3:30pm to 6:00pm_ but adjusted to incorporate students from other time zones): 
...
**Preparation and Participation** (5%): It is imperative that students keep up with the asynchronous materials and attend synchronous lectures on time. See the "Participation" section in the Course Policies section for more details.
...
<!-- Being virtual, "attending" class will take multiple forms.  -->
...
- I will respond to all emails/slack questions **_within 24 hours_** of being sent during a weekday. **_I will not respond to emails/slack sent late Friday (after 5:00 pm) or during the weekend until Monday (9:00 am)_**. Please plan accordingly if you have questions regarding current or upcoming assignments. Please address the professor and TA by their last name unless stated otherwise.
