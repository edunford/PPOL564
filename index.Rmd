...
#### [**Virtual Zoom Office Hours**](https://georgetown.zoom.us/j/96444963432) (Wednesdays 4pm - 6pm)
...
- **Office Hours**: Wednesdays 4pm to 6pm (See `Virtual Classroom` tab for link)
...
- **Office Hours**: [Book an appointment via Calendly](https://calendly.com/maddiepickens)
...
- **Office Hours**: [Book an appointment via Calendly](https://calendly.com/cad162)
...
The best way to reach the TA/Professor is via the class Slack channel (PPOL-564-Fall-2021). Please click on the [Class Slack Channel Invite](https://join.slack.com/t/ppol-564-fall-2021/shared_invite/zt-ukj26377-a00MPhjVTkh2rs8VSTrmzw) to join the class work-space. 
...
<!-- [_Introductions, Installations, and IDEs_](lectures/week_01/asynchronous_lecture_material/week01-async-materials.html) -->

<br><br>

### **Week 2: Time Travel and Other Necessities**<br>_Version Control, Workflow, and Reproducibility_
<!-- [_Version Control, Workflow, and Reproducibility_](lectures/week_02/asynchronous_lecture_material/week-02-async-materials.html) -->

<br><br>

### **Week 3: Learning Parseltongue**<br>_Object-Oriented Programming in Python_
<!-- [_Object-Oriented Programming in Python_](lectures/week_03/asynchronous_lecture_material/week-03-async-material.html) -->

<br><br>

### **Week 4: On Time and Space**<br>_Introduction to Algorithms_

<!-- [_Introduction to Algorithms_](lectures/week_04/week-04-async-material.html) -->

<br><br>

### **Week 5: Long Live the Data Frame**<br>_From Nested Lists to Data Frames_

<!-- [_From Nested Lists to Data Frames_](lectures/week_05/week-05-async-material.html) -->

<br><br>

### **Week 6: Modern Snake Charming**<br>_Approaches to Data Manipulation in Python_

<!-- [_Approaches to Data Manipulation in Python_](lectures/week_06/week-06-async-material.html) -->

<br><br>

### **Week 7: Interrogation Techniques**<br>_Data Visualization and Exploration_

<!-- [_Data Visualization and Exploration_](lectures/week_07/week-07-async-material.html) -->

<br><br>

### **Week 8: Automated Heists**<br>_Drawing from (Un-)Structured Data Sources_

<!-- [_Drawing from (Un-)Structured Data Sources_](lectures/week_08/week-08-async-material.html) -->

<br><br>

### **Week 9: The Signal and the Noise**<br>_Introduction to Statistical Learning_

<!-- [_Introduction to Statistical Learning_](lectures/week_09/week-09-async-material.html) -->

<br><br>

### **Week 10: Casting Shadows in $N$-Dimensions**<br>_Continuous Outcomes and Linear Regression_

<!-- [_Continuous Outcomes and Linear Regression_](lectures/week_10/week-10-async-material.html) -->

<br><br>

### **Week 11: Hot Dog, Not Hot Dog**<br>_Probability, Bayes Theorem, and Classification_

<!-- [_Probability, Bayes Theorem, and Classification_](lectures/week_11/week-11-async-material.html) -->

<br><br>

### **Week 12: Trees and Neighbors**<br>_Algorithmic Approaches to Supervised Learning_

<!-- [_Algorithmic Approaches to Supervised Learning_](lectures/week_12/week-12-async-material.html) -->

<br><br>

### **Week 13: Peeking inside the Black Box**<br>_Interpretable Machine Learning_

<!-- [_Interpretable Machine Learning_](lectures/week_13/week-13-async-material.html) -->
