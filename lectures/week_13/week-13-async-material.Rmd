...
- Cover **how to implement** interpretability methods within an `sklearn` framework.
...
- [**Practice applying interpretable machine learning methods**](synchronous-material/interpretable_ml_walkthrough.html)
  - Download the <a href="synchronous-materials/interpretable_ml_walkthrough.ipynb" download><strong>`.ipynb` Notebook</strong></a>.
