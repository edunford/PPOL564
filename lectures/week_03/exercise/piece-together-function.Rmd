...
In your breakout groups, please but the following code chunks in order so that the code runs. Each function is designed to process the following string object. 
