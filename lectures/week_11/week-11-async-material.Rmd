...
Add a method to your `MyML` class called `.describe_training()` which generates summary statistics for the training data. Summary statistics should be round to the second decimal place.
